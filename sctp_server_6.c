...
int main(void) {
    ...
    handle_error(inet_pton(AF_INET6, SERVER_ADDR_6, &addr[1].sin6_addr), "inet_pton addr 1");
	addr[2].sin6_family = AF_INET6;
	addr[2].sin6_port = htons(SERVER_PORT);
    handle_error(inet_pton(AF_INET6, SERVER_ADDR2_6, &addr[2].sin6_addr), "inet_pton addr 2");
